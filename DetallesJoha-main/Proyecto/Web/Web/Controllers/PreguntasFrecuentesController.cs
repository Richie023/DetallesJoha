...
namespace Web.Controllers
{
    ...
    public class PreguntasFrecuentesController : Controller
    {
        ...
        public ActionResult Insertar(PreguntasFrecuentes entidad)
        {
            ...
            try
            {
                // Convertimos la respuesta en <ul><li>
                var lineas = (entidad.respuesta ?? "")
                ...
                {
                    ViewBag.MsjPantalla = respuesta?.Detalle ?? "Error al registrar la pregunta frecuente.";
                }
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Editar(PreguntasFrecuentes entidad)
        {
            ...
            try
            {
                // Convertimos la respuesta nuevamente a HTML con <ul><li>
                var lineas = (entidad.respuesta ?? "")
                    .Split(new[] { "\r\n", "\n" }, StringSplitOptions.RemoveEmptyEntries);
